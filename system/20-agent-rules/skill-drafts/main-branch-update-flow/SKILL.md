...
12. PR 머지를 확인합니다.
13. 원래 작업 브랜치로 돌아와 최신 main을 fetch합니다.
14. 원래 작업 브랜치를 최신 main 위로 rebase합니다.
15. worktree 정리 여부를 보고합니다.
...
```text
1. main 업데이트: main 기준 브랜치/PR/머지/rebase 절차로 반영합니다.
2. 지금 당장 업데이트: 현재 요청을 즉시 같은 절차로 처리합니다.
