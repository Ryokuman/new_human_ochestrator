...
- [`root-layer-manager`](root-layer-manager/SKILL.md): 정보가 0~3계층 중 어디에 속하는지 판단하거나, 프로젝트 task/issue/QA/decision/dashboard를 쓰기 전에 실제 project SSoT 위치, 기준 `project/<project-id>` 브랜치/worktree, task 번호 registry를 확인해야 할 때 사용합니다.
