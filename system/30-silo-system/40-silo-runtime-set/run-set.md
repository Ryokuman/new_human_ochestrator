...
Run Set은 2계층 `Project Work SSoT`의 일부입니다. root `main-v3/main`에는 실제 Run Set 실데이터를 두지 않고, project SSoT에서 실행 대상, report/evidence 위치, required runtime set을 관리합니다.
